...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2016/05/11 16:11:44 by jnomason          #+#    #+#              #
#    Updated: 2016/11/04 17:37:55 by jnomason         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c \
	   ...
	   ft_strsub.c ft_strjoin.c ft_strtrim.c  ft_itoa.c ft_putchar.c\
...
OBJ = ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o \
	   ...
	   ft_strsub.o ft_strjoin.o ft_strtrim.o  ft_itoa.o ft_putchar.o\
